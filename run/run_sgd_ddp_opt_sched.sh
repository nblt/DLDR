...
CUDA_VISIBLE_DEVICES=2 python -u train_psgd_dp.py --epochs=40 --arch='resnet20' --lr=1 --params_start=0 --params_end=40 --n_components=20 --pretrain_dir=$save_dir/sgd_ddp_opt_sched-CIFAR10-resnet20-128-0.01-adam-cosine-warmup --save_dir=$save_dir --log_wandb --project=DLDR