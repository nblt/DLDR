...
import pickle
import random
from model_dldr import reparam_model_v3
import resnet
...
def main():
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # train for one epoch
        train_stats, train_epoch_loss, train_epoch_acc = train(args, train_loader, reparam_model, P, param0, criterion, optimizer, epoch, lr_scheduler)
        # Bk = torch.eye(args.n_components).cuda()

        # evaluate on validation set
        val_stats, prec1, test_epoch_loss, test_epoch_acc = validate(args, val_loader, reparam_model, P, param0, criterion, epoch)
...
def train(args, train_loader, model, P, param0, criterion, optimizer, epoch, lr_scheduler=None):
    # Run one train epoch
